...
export const dummyTasks = [
  new Task(
    ...
    "Mit der Teilnahme bei \"Lärm in der Stadt\" kannst du die lautesten und leisesten Orte in deiner Stadt entdecken. Benutze einfach dein Smartphone und nehme mit Hilfe des Mikrofons den Lärm in deiner Umgebung auf. Abschließend kannst du uns noch mit deinem persönlichen Lärmempfinden weiterhelfen.",
    {
      [InputType.GEOLOCATION]:
        "Die Position wird benötigt, damit wir wissen, wo der Lärm auftrat.",
      [InputType.MIC]:
        "Das Mikrofon wird zur Aufnahme des Umgebungslärms genutzt. Es wird dabei keine Sprachaufnahme angefertigt.",
      [InputType.SURVEY]:
        "Die Umfrage nutzen wir, um uns einen besseren Eindruck von der Lärmbeschaffenheit zu machen."
    },
    [
      new SensorTaskStep(
        "noise-step-2",
        ...
        [
          {
            ...
            description:
              "Da wir uns für den Lärm in der Stadt interessieren, bitten wir dich, Aufnahmen nur außerhalb von geschlossenen Einrichtungen wie Wohnungen oder öffentlichen Gebäuden zu machen."
          },
          {
            ...
            description:
              "Damit die Aufnahmen so präzise wie möglich werden, halte dein Smarphone vor dir in Brusthöhe und halte es von dir Weg."
          },
          {
            title: "Ein Moment der Stille",
            description:
              "Die Aufnahme dauert etwa 10 Sekunden. Wichtig ist, dass du dich während der Aufnahme ruhig verhälst. Wir wollen ja nur den Umgebungslärm messen. ;)"
          }
        ],
  ...
  new Task(
    ...
    {
      [InputType.GEOLOCATION]:
        "Cupcake ipsum dolor sit amet tootsie roll tootsie roll jelly-o",
      [InputType.DUMMY]:
        "Cupcake ipsum dolor sit amet tootsie roll tootsie roll jelly-o"
    },
    [
