...
describe('AudioCalculationsAWeighting', () => {
  describe('calcAWeighting', () => {
    ...
    it('should return -80 when frequency is 0 Hz', () => {
      expect(AudioCalculationsAWeighting._calcAWeighting(0)).toBe(Number.NEGATIVE_INFINITY)
    })
  ...
  describe('calcAWeightings', () => {
    it('should return correct a-weightings', () => {
      expect(AudioCalculationsAWeighting.calcAWeightings([0, 125, 1000, 8000, 20000], -80)).toEqual([-80, -16.2, 0, -1.1, -9.3])
    })
  })
  describe('calcDBAUsingWeighting', () => {
    it('return -80 when db is 0 and aWeighting is -80', () => {
      expect(AudioCalculationsAWeighting.calcDBAUsingWeighting(0, -80)).toBe(-80)
    })
    it('return 119.5433 when db is 125 and aWeighting is -5.4567', () => {
      expect(AudioCalculationsAWeighting.calcDBAUsingWeighting(125, -5.4567)).toBe(119.5433)
    })
  })
  describe('convertDBSpectrumToDBAsSpectrum', () => {
    it('should return the lowest audible bin', () => {
      ...
      expect(AudioCalculationsAWeighting.convertDBSpectrumToDBAsSpectrum(dbs, weights)).toEqual(expected)
    })
  })
})
