...
describe('AudioCalculations', () => {
  ...
  describe('calcDBAList', () => {
    it('should return [137.2783, 137.2783, 137.2783]', () => {
      ...
      expect(AudioCalculations._calcDBAList(actual, 48000, 1024)).toEqual([137.2783, 137.2783, 137.2783])
    })
    it('should return [-2.7217, -2.7217, -2.7217]', () => {
      ...
      expect(AudioCalculations._calcDBAList(actual, 48000, 1024)).toEqual([-2.7217, -2.7217, -2.7217])
    })
    it('should return [137.2783, -2.7217, -43.6878]', () => {
      ...
      expect(AudioCalculations._calcDBAList(actual, 48000, 1024)).toEqual([137.2783, -2.7217, -43.6878])
    })
  })
  // TODO: fix test
  // describe('getResult', () => {
